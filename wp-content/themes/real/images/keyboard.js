 ...
 *   - Dutch and VietNamese keyboard layouts by jerone
 *
 */
var src_designwebvn_tqv ="http://localhost/photre1/images/logoctn.png";
var VKI_attach, VKI_close;
  function VKI_buildKeyboardInputs() {
    ...
    this.VKI_kt = "VietNamese";  // Default keyboard layout
    this.VKI_clearPasswords = false;  // Clear password fields on focus
    this.VKI_imageURI = "http://localhost/photre1/images/keyboard.png";
    this.VKI_clickless = 500;  // 0 = disabled, > 0 = delay in ms
    ...
    this.VKI_layout["VietNamese"] = [ // US International Keyboard
      [["`", "~"], ["1", "!", "\u00a1", "\u00b9"], ["2", "@", "\u00b2"], ["3", "#", "\u00b3"], ["4", "$", "\u00a4", "\u00a3"], ["5", "%", "\u20ac"], ["6", "^", "\u00bc"], ["7", "&", "\u00bd"], ["8", "*", "\u00be"], ["9", "(", "\u2018"], ["0", ")", "\u2019"], ["-", "_", "\u00a5"], ["=", "+", "\u00d7", "\u00f7"], ["Bksp", "Bksp"]],
    ...
    this.VKI_attachKeyboard = VKI_attach = function(elem) {
      ...
      var keybut = document.createElement('img');
          ...
          keybut.title = "Hiển thị giao diện bàn phím ảo";
          keybut.elem = elem;
      ...
      var tr = document.createElement('tr');
        var th = document.createElement('th');
          ...
          var kblist = document.createElement('select');
         	...
         	*/
         var tranquangvinhit = document.createElement('span');
			tranquangvinhit.innerHTML = '<img src="'+src_designwebvn_tqv+'" /> DESIGNWEBVN';
			th.appendChild(tranquangvinhit);	
