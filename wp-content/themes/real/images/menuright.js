...
document.write('<div onmouseover="getPosition(this);actionMenu(\'pointer\',\'20\')" style="background-color: rgb(204, 238, 124); color: rgb(255, 255, 255);" class="awemnbspm" description="DESIGNWEBVN" target="_self" url="http://designwebvn.com">http://designwebvn.com</div>')
document.write('<div onmouseover="getPosition(this);actionMenu(\'pointer\',\'20\')" style="background-color: rgb(204, 238, 124); color: rgb(255, 255, 255);" class="awemnbspm" description="DESIGNWEBVN" target="_self" url="http://designwebvn.com">http://designwebvn.com</div>');
document.write('<div class="awemnbspm2"><hr /></div>');
document.write('<div style="background-color: rgb(132, 192, 45); color: rgb(255, 255, 255);" class="awemnbspm2" description="Design by DESIGNWEBVN" target="_self" url="http://designwebvn.com">Design by DESIGNWEBVN</div></div>');
...
document.oncontextmenu=AwemNbspm;document.onclick=AWemNbspm;};
	function check_formsearchtranquangvinhit(the_form)
	{	
        var the_theloaibds   = the_form.theloaibds.value;
        var the_masoid   = the_form.masoid.value;
      if ((the_theloaibds=='0' ) &&  (the_masoid=='Nhập mã số'))
		{
			alert("Xin mời nhập thể loại bất động sản hoặc mã số tìm kiếm !");
			the_form.masoid.focus();
			return false;
		}
