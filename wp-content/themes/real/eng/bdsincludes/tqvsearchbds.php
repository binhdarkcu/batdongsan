...
################################################# 
    ...
    die ("<div align='center'><font color='blue' size='5'> Access Denied ! Contact Designwebvn@gmail.com");
    		           ...
    		           if($theloaibds=='0' && $masoid=='Input ID'){
    		           	   
    		           	   echo "<script> alert('Please enter the real estate category or ID search !') </script>";
    		           	   include"bdsincludes/tqvmainbds.php";
    		           	   
    		           }
    		   elseif(($theloaibds=='0') && ($masoid!='Input ID')){ ?>
    		     ...
    		     <table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      ...
    		      <tr><td background='images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
    		        ...
    		        <table border='0' width='485' name='tranquafngvinhfeds' cellSpacing=0 cellPadding=0>
    		          	  ...
    		          	  <tr><td><div align='center'><font color='#366e03'> List housing for rent <?php echo "with ID "  .$masoid;  ?>  </font></td></tr>
    		      ...
    		      $page=intval($_GET["page"]);
	               if($page=="") $page="1";
	               $sqlvinh=@mysql_query("select * from tqv_bdsnewsbdseng  where tqvnewsbds_tinhtrang='1'  and tqvnewsbds_maso='$masoid' order by tqvnewsbds_id");
	               $totalrow=@mysql_num_rows($sqlvinh);
	               $rowperpage=15;
	               $max_page=ceil($totalrow/$rowperpage);
	               $start=($page-1)* $rowperpage;  
    	           $sqlstate=@mysql_query("select * from tqv_bdsnewsbdseng  where tqvnewsbds_tinhtrang='1' and tqvnewsbds_maso='$masoid'  order by tqvnewsbds_id desc limit $start,$rowperpage");
    		...
    		<tr><td width='523'>
    		     <table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      ...
    		      <tr><td background='images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
    		        <div align='center'>
    		        <table border='0' width='485' name='tranquafngvinhfeds' cellSpacing=0 cellPadding=0>
    		            <?php  $sqlcatebds=@mysql_query("select * from tqv_catebdseng where tqv_catebdsid='$theloaibds'"); $vnumb=@mysql_num_rows($sqlcatebds); $rowcatebds=@mysql_fetch_assoc($sqlcatebds); $name=$rowcatebds['tqv_catename']; $tqv_catebdsid =$rowcatebds['tqv_catebdsid']; ?>
    		          	  <tr><td><div align='center'><font color='#366e03'> List housing for rent <?php echo "with category "  .$name;  ?>  </font></td></tr>
    		             <tr><td height=15></td></tr>
    		      ...
    		      $page=intval($_GET["page"]);
	               if($page=="") $page="1";
	               $sqlvinh=@mysql_query("select * from tqv_bdsnewsbdseng  where tqvnewsbds_tinhtrang='1'  and tqv_catebdsid='$theloaibds' order by tqvnewsbds_id");
	               $totalrow=@mysql_num_rows($sqlvinh);
	               $rowperpage=15;
	               $max_page=ceil($totalrow/$rowperpage);
	               $start=($page-1)* $rowperpage;  
    	           $sqlstate=@mysql_query("select * from tqv_bdsnewsbdseng  where tqvnewsbds_tinhtrang='1' and tqv_catebdsid='$theloaibds'  order by tqvnewsbds_id desc limit $start,$rowperpage");
                   $kiemtratin=@mysql_num_rows($sqlstate);
                   if($kiemtratin==NULL){
                   	   echo "<Tr><td> Could not find the data you need to find </td></tr></table>"; }else {
                   while($rowstate=@mysql_fetch_assoc($sqlstate)){
    		...
    		<tr><td width='523'>
    		     <table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      ...
    		      <tr><td background='images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
    		        ...
    		        <table border='0' width='485' name='tranquafngvinhfeds' cellSpacing=0 cellPadding=0>
    		            <?php  $sqlcatebds=@mysql_query("select * from tqv_catebdseng where tqv_catebdsid='$theloaibds'"); $vnumb=@mysql_num_rows($sqlcatebds); $rowcatebds=@mysql_fetch_assoc($sqlcatebds); $name=$rowcatebds['tqv_catename']; $tqv_catebdsid =$rowcatebds['tqv_catebdsid']; ?>
    		          	  <tr><td><div align='center'><font color='#366e03'> List housing for rent <?php echo "with category "  .$name;  ?> and ID  <?php echo $masoid; ?> </font></td></tr>
    		             <tr><td height=15></td></tr>
    		          <tr ><td><table border='0' width='485' name='tranquafngvinhfedds' cellSpacing=0 cellPadding=0>
    		      ...
    		      $page=intval($_GET["page"]);
	               if($page=="") $page="1";
	               $sqlvinh=@mysql_query("select * from tqv_bdsnewsbdseng  where tqvnewsbds_tinhtrang='1'  and tqv_catebdsid='$theloaibds' and tqvnewsbds_maso='$masoid' order by tqvnewsbds_id");
	               $totalrow=@mysql_num_rows($sqlvinh);
	               $rowperpage=15;
	               $max_page=ceil($totalrow/$rowperpage);
	               $start=($page-1)* $rowperpage;  
    	           $sqlstate=@mysql_query("select * from tqv_bdsnewsbdseng  where tqvnewsbds_tinhtrang='1' and tqv_catebdsid='$theloaibds' and tqvnewsbds_maso='$masoid'  order by tqvnewsbds_id desc limit $start,$rowperpage");
                   $kiemtratin=@mysql_num_rows($sqlstate);
                   if($kiemtratin==NULL){
                   	   echo "<Tr><td> Could not find the data you need to find </td></tr></table>"; }else {
                   while($rowstate=@mysql_fetch_assoc($sqlstate)){
