   <?php  
   	   ...
   	   echo "<script> alert('You must register new members to use this feature !') </script>";  
   	   $url="index.php?tqvbds=tqvregistermember";
       header("Location: ".$url."");
    ...
    <?php include 'bdsincludes/tqvleftbds.php'; ?>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='images/managementnews.png' border='0' width='20' height='20'><font color='#366e03'> Members List </font></td></tr>
    		      <tr><td background='images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
                      ...
                      <tr><td width=30><div align='left'><span class='quangvinhdesign'> ID  </span></td><td width='3'></td><td width='100'><div align='left'><span class='quangvinhdesign'> Full name </span></div></td> <td width='3'></td><td width='100'><div align='left'><span class='quangvinhdesign'> Email </span> </td><td width='5' ></td><td width='100'> <div align='left'><span class='quangvinhdesign'> Mobile </span></td></tr>
    		         </table> 
