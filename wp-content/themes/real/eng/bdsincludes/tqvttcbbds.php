...
<table id="tranquangvinhdesignfr" name="tranquangvinhdesigngr" width="210"  border="0" cellpadding="0" cellspacing="0">
     ...
     <tr><td width='115'><?php 
		   ...
		   ?> </td> <td width=2> </td> <td width='93'>
               ...
               <tr bgcolor="#FFFFFF"><td ><div align='left'> <img src='images/ngoaite.png' width=31 height=27 border=0>Exchange rate </div></td></tr></table>
		   	   <?php 
		       
		       echo"<IFRAME id=3DtabFrame name=3DtabFrame src='bdsincludes/tqvtygiabds.php' frameBorder=0  scrolling=auto marginheight='0' marginwidth='0' width=105 height=48  = bgcolor='#2e5681' allowTransparency></IFRAME>";
		   ?> </td></tr> 
