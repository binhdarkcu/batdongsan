...
<span class="jFlowControl2"><font color='#003366'><b></b> </span>
 ...
 <table border='0' width='480' name='quangvinhitdesign' cellSpacing=0 cellPadding=0  >
     ...
     <?php echo  "<div align='center'><table border='0' width='150' height='100' cellSpacing=0  cellPadding=0><tr><td valign='center'><a href='$tqvpartner_url' target='_blank'><img src='images/tqvdoitacbds/$tqvpartner_logo' style='border:#c6c6c6 solid 2px' border='0' width='120' height='91' title='$tqvpartner_name' alt'$tqvpartner_name'></a></td></tr></table>";
     			 }
     			  ?> 
          </td>
		          <TD>
         ...
         <?php 
          $sqlpartner=@mysql_query("select * from tqv_bdspartner where tqvpartner_status =1 order by tqvpartner_id desc limit 1,1"); 
           while($rowpartner=@mysql_fetch_assoc($sqlpartner)){
             ...
             $tqvpartner_url=$rowpartner['tqvpartner_url'];  
             $tqvpartner_intro=$rowpartner['tqvpartner_intro'];  ?>
     <?php echo  "<table border='0' width='150' height='100' cellSpacing=0  cellPadding=0><tr><td valign='center'><a href='$tqvpartner_url' target='_blank'><img src='images/tqvdoitacbds/$tqvpartner_logo' style='border:#c6c6c6 solid 2px' border='0' width='120' height='91' title='$tqvpartner_name' alt'$tqvpartner_name'></a></td></tr></table>";
     			 }
     			  ?> 
         ...
         <?php 
          $sqlpartner=@mysql_query("select * from tqv_bdspartner where tqvpartner_status =1 order by tqvpartner_id desc limit 2,1"); 
           while($rowpartner=@mysql_fetch_assoc($sqlpartner)){
             ...
             $tqvpartner_url=$rowpartner['tqvpartner_url'];  
             $tqvpartner_intro=$rowpartner['tqvpartner_intro'];  ?>
     <?php echo  "<table border='0' width='150' height='100' cellSpacing=0  cellPadding=0><tr><td valign='center'><a href='$tqvpartner_url' target='_blank'><a href='$tqvpartner_url' target='_blank'><img src='images/tqvdoitacbds/$tqvpartner_logo' style='border:#c6c6c6 solid 2px' border='0' width='120' height='91' title='$tqvpartner_name' alt'$tqvpartner_name'></a></td></tr></table>";
     			 }
     			  ?> 
         </td></tr></table></div> 			  
        </td>
