...
################################################# 
    ...
    die ("<div align='center'><font color='blue' size='5'> Access Denied ! Contact Designwebvn@gmail.com");
       ...
       if($rowpass){
   	           ...
   	           echo "<script> alert('Tên truy cập đã tồn tại! Bạn chọn tên khác') </script>";  
   	         }
   	    else { 
               ...
               $msg="Đăng ký thành công! Chúng tôi sẽ kích hoạt thành viên sau 24h . ";
   	         }
   	         }
 ...
 <table border='0' width='980' name='quangvinhit' cellSpacing=0 cellPadding=0>
    	<tr><td width='229' valign='top'>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='<?php echo $rootbds; ?>/images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='<?php echo $rootbds; ?>/images/changeacount.gif' border='0' width='25' height='20'><font color='#366e03'> Đăng ký thành viên </font></td></tr>
     ...
     <div align='center'> <table width="92%" border="0" align="center" cellpadding="0" cellspacing="4">
        ...
        <tr>
           <td  colspan='2'><div align='center'> <font color='#366e03'>Trở thành thành viên Đà Nẵng renting để được hưởng những dịch vụ tốt nhất của chúng tôi</font></td>
           
        </tr>
        <tr>
           <td width="10%"></td>
           <td width="90%" style="padding: 1px;" ><div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'> <span class='tomtat1'> Họ tên  </td><td width='2%'></td><td width='78%'><div align='left'> <input name='hoten' type="text" size="43"  class="button2" onmouseover="showTooltip('Đăng ký thành viên  Đà Nẵng Renting','Bạn hãy điền Họ tên','Email: admin@danangrenting.com','<?php echo $rootbds; ?>/images/email.png','<?php echo $rootbds; ?>/images/namectnvietnam.png')" onmouseout="hideTooltip()" /> </td></tr></table> </td>
        </tr>
        <tr>
          <td width="10%"></td>
          <td width="90%" style="padding: 1px;" > <div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'> <span class='tomtat1'> Tên đăng nhập </td><td width='2%'></td><td width='78%'><div align='left'> <input name="tendangnhap" type="text" size="43" class="button2" onmouseover="showTooltip('Đăng ký thành viên  Đà Nẵng Renting','Bạn hãy điền tên đăng nhập','Email:  admin@danangrenting.com','<?php echo $rootbds; ?>/images/email.png','<?php echo $rootbds; ?>/images/addressctnvietnam.png')" onmouseout="hideTooltip()" /></td></tr></table></td>
        </tr>
        <tr>
          <td width="10%"></td>
          <td width="90%" style="padding: 1px;" > <div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'> <span class='tomtat1'> Mật khẩu </td><td width='2%'></td><td width='78%'><div align='left'> <input name="matkhau" type="password" size="43" class="keyboardInput" class="button2" onmouseover="showTooltip('Đăng ký thành viên  Đà Nẵng Renting','Bạn hãy điền mật khẩu','Email:  admin@danangrenting.com','<?php echo $rootbds; ?>/images/email.png','<?php echo $rootbds; ?>/images/addressctnvietnam.png')" onmouseout="hideTooltip()" /></td></tr></table></td>
        </tr>
        	<tr>
          <td width="10%"></td>
          <td width="90%" style="padding: 1px;" > <div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'> <span class='tomtat1'>Nhập lại mật khẩu</td><td width='2%'></td><td width='78%'><div align='left'> <input name="matkhauxn" class="keyboardInput" type="password" size="43" class="button2" onmouseover="showTooltip('Đăng ký thành viên  Đà Nẵng Renting','Bạn hãy điền xác nhận mật khẩu','Email:  admin@danangrenting.com','<?php echo $rootbds; ?>/images/email.png','<?php echo $rootbds; ?>/images/addressctnvietnam.png')" onmouseout="hideTooltip()" /></td></tr></table></td>
        </tr>	
       <tr>
       		<td width="10%"></td>
          <td width="90%" style="padding: 1px;" ><div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'><span class='tomtat1'> Email  </td><td width='2%'></td><td width='78%'><div align='left'><input name="email" type="text" size="43" class="button2" onmouseover="showTooltip('Đăng ký thành viên  Đà Nẵng Renting','Bạn hãy điền email','Email:  admin@danangrenting.com','<?php echo $rootbds; ?>/images/email.png','<?php echo $rootbds; ?>/images/emailctnvietnam.png')" onmouseout="hideTooltip()" /></td></tr></table></td>
        </tr>
         <tr>
          <td width="10%"></td>
          <td width="90%" style="padding: 1px;"><div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'><span class='tomtat1'> Điện thoại </td><td width='2%'></td><td width='78%'><div align='left'><input name="dienthoai" type="text" size="43"  class="button2" onmouseover="showTooltip('Đăng ký thành viên  Đà Nẵng Renting','Bạn hãy điền Số điện thoại','Email:  admin@danangrenting.com','<?php echo $rootbds; ?>/images/email.png','<?php echo $rootbds; ?>/images/phonectnvietnam.png')" onmouseout="hideTooltip()" /> </td></tr></table></td>
        </tr>
       
        <tr><td colspan='2' height='10'></td></tr>
        <tr>
          <td width="10%"></td>	
          <td width="90%" style="padding: 1px;" ><div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td colspan='3'><div align='left'><span class='tomtat1'> Thông tin cá nhân </td></tr></table></td>
        </tr>
        <tr>
           <td width="10%"></td>	
