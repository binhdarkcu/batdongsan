...
################################################# 
    ...
    die ("<div align='center'><font color='blue' size='5'> Access Denied ! Contact Designwebvn@gmail.com");
       ...
       if($rowpass){
              ...
              $msg="Thay đổi thông tin không thành công !";
             } 
            }
 ...
 <table border='0' width='980' name='quangvinhit' cellSpacing=0 cellPadding=0>
    	...
    	<?php include"bdsincludes/tqvleftbds.php"; ?>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='images/changeacount.gif' border='0' width='25' height='20'><font color='#366e03'> Thay đổi thông tin cá nhân </font></td></tr>
     ...
     <div align='center'> <table width="90%" border="0" align="center" cellpadding="0" cellspacing="4">
       ...
       <tr>
        ...
        <tr>
          <td width="2%"></td>
          <td width="98%" style="padding: 1px;" > <div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'> <span class='tomtat1'> Họ và tên</td><td width='2%'></td><td width='78%'><div align='left'> <input name="ctnhoten" type="text" size="53" class="button2"  value="<?php echo $tqvad_name; ?>"/></td></tr></table></td>
        </tr>
          ...
          <td width="98%" style="padding: 1px;" > <div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%'> <span class='tomtat1'>Phone </td><td width='2%'></td><td width='78%'><div align='left'> <input name="ctnphone" type="text"  size="53" class="button2"  value="<?php echo $tqvad_mobile; ?>"/></td></tr></table></td>
            ...
            <tr>
          <td width="2%"></td>
          <td width="98%" style="padding: 1px;" > <div align='left'><table width="100%" border="0" cellpadding="0" cellspacing="0" class="bodsfx"><tr><td width='20%' colspan='3'><div align='left'> Giới thiệu bản thân </td></tr></table></td>
        </tr>
           <tr>
          <td width="2%"></td>
