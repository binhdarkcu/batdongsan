    ...
    <?php include"bdsincludes/tqvleftbds.php"; ?>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='<?php echo $rootbds; ?>/images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='images/managementnews.png' border='0' width='20' height='20'><font color='#366e03'> Danh sách Đối tác và khách hàng</font></td></tr>
    		      ...
    		      <tr><td background='<?php echo $rootbds; ?>/images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
    		       ...
    		       $vinh=1+0;
    	           $sqlstate=@mysql_query("select * from tqv_bdspartner order by tqvpartner_id desc limit 3");
    		    ...
    		    ?>   
    		      <td >
    		        ...
    		        <a href='<?php echo $tqvpartner_url; ?>' target='_blank'><img src='<?php echo $rootbds; ?>/images/tqvdoitacbds/<?php echo $tqvnews_anhmh;?>' width='120' height='90' border='0' alt='<?php echo $tqv_qhname; ?>' title='<?php echo $tqv_qhname; ?>' style='border:#c6c6c6 solid 2px' ></a><td></tr>
