...
<table id="tranquangvinhmenuleft" width="229"  border="0" cellpadding="0" cellspacing="0">
   ...
   <?php 
	...
	<tr>
		<td colspan="6">
			<img src="images/batdongsan_green_34.gif" width="229" height="125" alt="" valign='top'></td>
	</tr>
</table>

    	
    	</td><td  height='1355' width='751' valign='top'>
    ...
    <tr><td height=5 colspan='3'></td></tr>
    		 ...
    		 if (is_int($vinh/3) && ($vinh>=3))
    		    ...
    		    ?>   
    	                 <td >
    		        <table border='0'  name='tranquafngvinhfe&#273;ds' cellSpacing=0 cellPadding=0><tr><td>
    		        <a href='index.php?tqvbds=detailnewsrentbds&cateid=<?php echo $tqv_catebdsid; ?>&newsid=<?php echo $tqvnews_id; ?>'><img src='images/newsbds/<?php echo $tqvnews_anhmh;?>' width='140' height='155' border='0' alt='<?php echo $tqv_qhname; ?>' title='<?php echo $tqv_qhname; ?>' style='border:#c6c6c6 solid 2px' ></a><td></tr>
    		        <tr><td height='7'></td></tr>
    		        <tr><td width='150'><div align='left'>
    		        <a href='index.php?tqvbds=detailnewsrentbds&cateid=<?php echo $tqv_catebdsid; ?>&newsid=<?php echo $tqvnews_id; ?>' class='designwfdsffeafffdfsfe' title='<?php echo $tqv_qhnamefull; ?>'><?php echo $tqv_qhname; ?></a><td></tr>
    		        </table>
