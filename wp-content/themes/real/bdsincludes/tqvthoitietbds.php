...
<LINK media=screen href="<?php echo $rootbds; ?>/images/tqvttcbbds.css" type=text/css rel=stylesheet>
<style type="text/css">
.lienket{
...
function change(id){
    $('<?php echo $rootbds; ?>/bdsincludes/tqvweatherbds.php?id='+id,'noidung');
}
</script>
  ...
  <tr>
    <td align='center'>
       <form name="form1"  method="post" action="">
           <select name="select" class ='lienket' style="font-family: tahoma; font-size: 9.7pt" onChange="change(this.value);">
               <option value="4" ><span class='thoitiet'>Đà Nẵng</span></option> >
               ...
               <option value="6" selected="select"><span class='thoitiet'>Kon Tum</span></option>
      </select>
      </form>
    </td>
  </tr>
...
<span class='thoitiet'><?php echo $xml[13]['value']; ?></p></span>
