...
#  ----------------------------------------	    # 
	...
	?>
 <form id="form4455" name="form4455" method="post" action="index.php?tqvbds=checklogin" onsubmit="return check_form(this)">
<table id="tranquangvinhdesignfr" name="tranquangvinhdesigngr" width="200"  border="0" cellpadding="0" cellspacing="0">
    ...
    <tr><td height=5 colspan='3'></td></tr>
   <tr><td  colspan='3'><div align='center'> <input src="<?php echo $rootbds; ?>/images/batdongsan_green_31.gif" onmouseover="this.src='<?php echo $rootbds; ?>/images/batdongsan_green_31.gif'" onmouseout="this.src='<?php echo $rootbds; ?>/images/batdongsan_green_31.gif'" type="image" width="106" height="37"></td></tr>	               
</table>
</form>
		<?php } ?>