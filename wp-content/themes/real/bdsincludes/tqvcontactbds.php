...
################################################# 
    ...
    die ("<div align='center'><font color='blue' size='5'> Access Denied ! Contact Designwebvn@gmail.com");
       ...
       if($rowpass){
   	           ...
   	           $msg="Thông tin liên hệ đã có trong có sở dữ liệu!";
   	         }
   	    else { 
               ...
               $msg="Thông tin liên hệ đã được cập nhật. Chúng tôi sẽ hồi âm trong thời gian sớm nhất. Cảm ơn bạn đã liên hệ cho chúng tôi";
   	         }
   	         }
    ...
    <?php include"bdsincludes/tqvleftbds.php"; ?>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='<?php echo $rootbds; ?>/images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='<?php echo $rootbds; ?>/images/managementnews.png' border='0' width='20' height='20'><font color='#366e03'> Liên hệ </font></td></tr>
