    ...
    <?php include"bdsincludes/tqvleftbds.php"; ?>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='<?php echo $rootbds; ?>/images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='<?php echo $rootbds; ?>/images/managementnews.png' border='0' width='20' height='20'><font color='#366e03'> Danh sách tin tức và pháp luật</font></td></tr>
    		      ...
    		      <tr><td background='<?php echo $rootbds; ?>/images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
    		       ...
    		       $vinh=1+0;
    	           $sqlstate=@mysql_query("select * from tqv_bdsnews order by tqvnews_id desc limit 12");
                   while($rowstate=@mysql_fetch_assoc($sqlstate)){
                   $tqv_qhnamefull=$rowstate["tqvnews_heading"];
  $news_headingseo=designwebvntranquangvinh($tqv_qhname);                 $tqv_qhname=tranquangvinhtieude($rowstate["tqvnews_heading"]);
  $tqvcat_id=$rowstate["tqvcat_id"];
    		    ...
    		    ?>   
    		      <td >
    		        ...
    		        <a href='<?php echo $rootbds; ?>/chi-tiet-tin/<?php echo $tqvcat_id; ?>/<?php echo $tqvnews_id; ?>/<?php echo $news_headingseo; ?>.html'><img src='<?php echo $rootbds; ?>/images/newsbds/<?php echo $tqvnews_anhmh;?>' width='120' height='90' border='0' alt='<?php echo $tqv_qhname; ?>' title='<?php echo $tqv_qhname; ?>' style='border:#c6c6c6 solid 2px' ></a><td></tr>
    		        <tr><td height='7'></td></tr>
    		        <tr><td width='150'><div align='left'>
    		        <a href='<?php echo $rootbds; ?>/chi-tiet-tin/<?php echo $tqvcat_id; ?>/<?php echo $tqvnews_id; ?>/<?php echo $news_headingseo; ?>.html' class='designwfdsffeafffdfsfe' title='<?php echo $tqv_qhnamefull; ?>'><?php echo $tqv_qhname; ?></a><td></tr>
    		        </table>
          </td> 
                 ...
                 echo "<tr  height='15'> </tr>";
    		       ...
    		       <tr><td height=27></td></tr>
    		         ...
    		         <tr><td height=10></td></tr>
    		            <?php  
      $sqlstate=@mysql_query("select * from tqv_bdsnews where tqvnews_status='1' and tqvnews_id != '$tqvnews_id' order by tqvnews_id desc limit 20");
      while ($rowstate=@mysql_fetch_assoc($sqlstate)){
      ...
      ?>  
       <tr><td height=27></td></tr>   
     <tr><td ><div align='left'><img src='images/list.png' border='0' height=21 width=25> <font color='#366e03'> Tìm kiếm tin tức theo ngày</font></td></tr>
    		       	   <tr><td ><div align='left'><font color=#549c13>---------------------------------------------------------</font></td></tr>		           
    		          <tr><td height=10></td></tr>
