    ...
    <?php include"bdsincludes/tqvleftbds.php"; ?>
    		...
    		<tr><td width='523'>
    			<table border='0' width='523' name='tranquangvinhfeds' cellSpacing=0 cellPadding=0>
    		      <tr><td background='images/batdongsan_greenmember_14.png' width='523' height='50' valign='center'><div align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='images/managementnews.png' border='0' width='20' height='20'><font color='#366e03'><?php $cate=intval($_GET['cateid']); $sqlcatebds=@mysql_query("select * from tqv_catebds where tqv_catebdsid='$cate'"); $rowcatebds=@mysql_fetch_assoc($sqlcatebds); $name=$rowcatebds['tqv_catename']; $tqv_catebdsid =$rowcatebds['tqv_catebdsid']; ?> <a href='index.php'> Trang chủ </a> - <a href='index.php?tqvbds=detailcatenewsbds&cateid=<?php echo $tqv_catebdsid; ?>'> <?php echo $name; ?></a></font></td></tr>
    		      ...
    		      <tr><td background='images/batdongsan_greenmember_17.png' width='523' height='1243' valign='top'>
	               ...
	               if($page=="") $page="1";
	               $sqlvinh=@mysql_query("select * from tqv_bdsnewsbds  where tqvnewsbds_tinhtrang='1'  and tqv_catebdsid='$cate' order by tqvnewsbds_id");
	               $totalrow=@mysql_num_rows($sqlvinh);
	               $rowperpage=15;
	               $max_page=ceil($totalrow/$rowperpage);
	               $start=($page-1)* $rowperpage;  
    		       $sqlstate=@mysql_query("select * from tqv_bdsnewsbds  where tqvnewsbds_tinhtrang='1'  and tqv_catebdsid='$cate' order by tqvnewsbds_id desc limit $start,$rowperpage");
	 ...
	 echo "<A HREF=\"index.php?tqvbds=detailcatenewsbds&cateid=&page=$max_page\" title=\"Trang cu&#7889;i $max_page\" class=song>Last</A><div>";
    		       ...
    		       <tr><td height=27></td></tr>
    		         ...
    		         <tr><td height=10></td></tr>
    		            <?php  
      $sqlstate=@mysql_query("select * from tqv_bdsnewsbds where tqvnewsbds_tinhtrang='1'  and tqv_catebdsid='$cate' order by tqvnewsbds_id desc limit 20");
      while ($rowstate=@mysql_fetch_assoc($sqlstate)){
