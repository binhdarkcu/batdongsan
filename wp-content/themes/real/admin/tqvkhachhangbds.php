...
$folder_upload_in = "../images/tqvdoitacbds/"; // Thu muc Upload 
...
<meta http-equiv="REFRESH" content="2; url=tqvkhachhangbds.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="tqvkhachhangbds.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> ';
    ...
    $q3 = "Insert into tqv_bdspartner set
	tqvpartner_name  = \"$title\",
    tqvpartner_logo = \"$file_rename\",
	tqvpartner_url = \"$company_url\",
    tqvpartner_intro = \"$content\",
	tqvadmin_id = \"{$member_id}\",
	tqvpartner_status=\"{$tinhtrang}\" 
	";
...
<script language="javascript">
	...
	{ var the_title    = the_form.title.value;
      if ((the_title==''))
		{
			alert("Bạn nhập thông tin đối tác!");
...
<center>
<form action="tqvkhachhangbds.php?act=do" enctype="multipart/form-data" method="post" NAME="mainform" onsubmit="return check_form(this)">
...
function edit() {
	$member_id = addslashes($_SESSION['member_id']);
	$id = intval( $_GET["id"] );
    $a = "select * from tqv_bdspartner where tqvpartner_id= \"$id\"";
...
echo("<br><br><br><br><br><br><div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"2; url=tqvkhachhangbds.php?dialoose=select\">
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"tqvkhachhangbds.php?dialoose=select\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>");
	...
	if ($file_name)
	{
		...
		";
	  	...
	  	$sql_select = @mysql_query("SELECT * FROM tqv_bdspartner WHERE tqvpartner_id='$id' ");
	  	$result_select = @mysql_fetch_array($sql_select);
	  	
	  	@unlink("../images/tqvdoitacbds/".$result_select["tqvpartner_logo"]);

	}
	
	$q3 .= "
	tqvpartner_url = \"$company_url\",
	tqvpartner_intro = \"$content\",tqvpartner_status='$tinhtrang'
	 where tqvpartner_id = \"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "<br><br>";
	exit;
...
<form enctype="multipart/form-data" method="POST" NAME="mainform"> 
	...
	<TABLE  cellSpacing=2 cellPadding=2 width="95%" border=0>
    	...
    	<tr> 
      	<td><font size="2"><b>T&#234;n Kh&#225;ch h&#224;ng/C&#244;ng ty:</b></font><br>
        <input onkeyup=initTyper(this); name="title" type="text" id="title" value="<? echo $c['tqvpartner_name']; ?>" size="136" ></td>
    	</tr>

    	<tr> 
      	<td><font size="2"><b>&#272;&#7883;a ch&#7881; trang web:</b></font><br>
        <input onkeyup=initTyper(this); name="company_url" type="text" id="company_url" value="<? echo $c['tqvpartner_url']; ?>"size="136" ></td>
    	</tr><tr> 
      	<td ><font size="2"><b>Gi&#7899;i thi&#7879;u chi ti&#7871;t:</b></font><br>
	<textarea  name="content" cols="136" rows="10" id="content"><? echo $c['tqvpartner_intro']; ?></textarea><br>
	</td>
	</tr>
...
<?
if($c['tqvpartner_logo'])
{
echo("<a href=\"../images/tqvdoitacbds/".$c['tqvpartner_logo']."\" target=\"_blank\">(<font size=1>Click v&#224;o &#273;&#226;y &#273;&#7875; xem &#7842;nh hi&#7879;n t&#7841;i</font>)</a><br>");
}
else
{
}
...
&nbsp;&nbsp;&nbsp;<select name="duyettin" id="duyettin" size=0>
	 <?php 
	$sqltt=@mysql_query("SELECT * FROM tqv_bdspartner WHERE tqvpartner_id='$id'");
	while ($rowtt=@mysql_fetch_assoc($sqltt)){
		$vinh=$rowtt['tqvpartner_status'];
		         if($vinh==1){ ?>
                          <option value="<?php echo $rowtt['tqvpartner_status']; ?>"> Được duy&#7879;t</option>
                          <option value="0">Ch&#432;a &#273;&#432;&#7907;c duy&#7879;t</option>
                 <?php } else { ?>
                 		  <option value="<?php echo $rowtt['tqvpartner_status']; ?>"> Ch&#432;a &#273;&#432;&#7907;c duy&#7879;t</option>
                          <option value="1">Được duy&#7879;t</option>
                 	<?php }
    } 
    ?>	  
...
<?
$sql=@mysql_query("SELECT * FROM `tqv_bdspartner` ORDER BY tqvpartner_id DESC") 
                                or die(mysql_error());
			        while($row=@mysql_fetch_array($sql)) {
				$id=$row[tqvpartner_id];
				$title=$row[tqvpartner_name];
			    $company_url=$row[tqvpartner_url];
				$images=$row[tqvpartner_logo];
				$tinhtrang=$row[tqvpartner_status];
...
<TD align=middle alignt=middle><P class=textxam12><a href=\"tqvkhachhangbds.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textxam12><a href=\"javascript:baoloi('tqvkhachhangbds.php?dialoose=delete&id=$id&file=$images&file2=$images_big')\">Xo&#225;</a></p</TD>
</TR>";
					}
?>
...
$q1 = "delete from tqv_bdspartner where tqvpartner_id = '$_GET[id]' ";
@mysql_query($q1) or die(mysql_error());

//delete the file
@unlink("../images/tqvdoitacbds/".$_GET[file]);
@unlink("../images/tqvdoitacbds/".$_GET[file2]);

	redirect("tqvkhachhangbds.php?dialoose=select");
