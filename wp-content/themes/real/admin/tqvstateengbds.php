...
require_once("../bdssecuritypt/bdssecurity.php");
  ...
  if(isset($submit) && $submit == 'Update')
  {
    ...
    $q3 = "insert into tqv_bdsquaneng set
    tqv_qhengname=\"$alt\",
    tqv_qhengstatus= \"$tinhtrang\"";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "
	<div align=\"center\">
            <meta http-equiv=\"REFRESH\" content=\"3; url=tqvstateengbds.php\"><br><br><br><br><br><br><br><br><br>
  ...
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href=\"tqvstateengbds.php\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>
</td></tr></table><br>";
...
if($_FILES['file_upload']['name'] == '') { 
	...
	$q3 = "update tqv_bdsquaneng set
  	tqv_qhengname= \"$tenlienket\",
	";
	
	$q3 .= "
	tqv_qhengstatus=\"$tinhtrang\" where tqv_qhengid=\"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
  echo "
	<div align=\"center\">
...
<script language='javascript' type='text/javascript'>
    ...
    {
    	temp = prompt( "", "'tqvstateengbds.php?" + pid );
    	return false;
    }
...
<?php
$n=0;
$sql=@mysql_query("SELECT * FROM `tqv_bdsquaneng` ORDER BY tqv_qhengid DESC") 
                                or die(mysql_error());
                                $line=0;
			                    while($row=@mysql_fetch_array($sql)) {
			                 	$line++;
			                 
			                 	$name=$row["tqv_qhengname"];
			                     $id =$row["tqv_qhengid"]; 
                                $status=$row["tqv_qhengstatus"];	
 echo"
...
<TD><center>
<a class='Market' href='tqvstateengbds.php?dialoose=Edit&id=$id' ><IMG SRC='images/edit.gif' alt='Sửa Quận Huyện'  title ='Sửa Quận Huyện' height='16' widht='16' border='0' ></a>
</center></TD>
...
<TD><center><a href=\"javascript:baoloi('tqvstateengbds.php?dialoose=Delete&id=$id&file=$images')\"><IMG border=0 SRC='images/remove.gif'></a></center></TD>
</TR>";
...
function Edit() {
$id = intval($_GET[id]);
$a = "select * from tqv_bdsquaneng where tqv_qhengid = \"$id\"";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa hay không?')){
		location.href='tqvstateengbds.php?dialoose=Delete&id=<? echo $c['tqv_qhengid']; ?>';
	}
}
</SCRIPT>
<script src="images/date-picker.js"></script>
...
<table width="550" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
            <td valign="top"><B>Tên Quận huyện:</B></td>
      <td><input size=61 name="tenlienket"  value="<? echo $c['tqv_qhengname']; ?>" type="text">
            </td>
    </tr>
...
<SELECT NAME="tinhtrang" size=0>
	...
	<?php 
	$sqltd=@mysql_query("SELECT * FROM tqv_bdsquaneng WHERE tqv_qhengid='$id'");
	while ($rowtd=@mysql_fetch_assoc($sqltd)){
		$tinhtrang=$rowtd['tqv_qhengstatus'];
		         if($tinhtrang==1){ ?>
                          <option value="<?php echo $rowtd['tqv_qhengstatus']; ?>">Hiển thị</option>
                          <option value="0">Không hiển thị</option>
                 <?php } else { ?>
                 		  <option value="<?php echo $rowtd['tqv_qhengstatus']; ?>">Không hiển thị</option>
                          <option value="1">Hiển thị</option>
                 	<?php }
    } 
    ?>	  
...
$id =intval($_GET[id]);
		...
		$q1 = "delete from tqv_bdsquaneng  where tqv_qhengid= '$id' ";
		@mysql_query($q1) or die(mysql_error());
echo "
	<div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"1; url=tqvstateengbds.php\"><br><br><br><br><br><br><br><br><br>
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
