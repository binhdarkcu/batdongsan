...
require_once("../bdssecuritypt/bdssecurity.php");
  ...
  if(isset($submit) && $submit == 'Update')
  {
    ...
    $q3 = "insert into tqv_bdsquan set
    tqv_qhname=\"$alt\",
    tqv_qhstatus= \"$tinhtrang\"";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "
	<div align=\"center\">
            <meta http-equiv=\"REFRESH\" content=\"3; url=tqvstatebds.php\"><br><br><br><br><br><br><br><br><br>
  ...
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href=\"tqvstatebds.php\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>
</td></tr></table><br>";
...
if($_FILES['file_upload']['name'] == '') { 
	...
	$q3 = "update tqv_bdsquan set
  	tqv_qhname= \"$tenlienket\",
	";
	
	$q3 .= "
	tqv_qhstatus=\"$tinhtrang\" where tqv_qhid=\"$id\"
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
  echo "
	<div align=\"center\">
...
<script language='javascript' type='text/javascript'>
    ...
    {
    	temp = prompt( "", "'tqvstatebds.php?" + pid );
    	return false;
    }
...
<?php
$n=0;
$sql=@mysql_query("SELECT * FROM `tqv_bdsquan` ORDER BY tqv_qhid DESC") 
                                or die(mysql_error());
                                $line=0;
...
<TD><center>
<a class='Market' href='tqvstatebds.php?dialoose=Edit&id=$id' ><IMG SRC='images/edit.gif' alt='Sửa Quận Huyện'  title ='Sửa Quận Huyện' height='16' widht='16' border='0' ></a>
</center></TD>
...
<TD><center><a href=\"javascript:baoloi('tqvstatebds.php?dialoose=Delete&id=$id&file=$images')\"><IMG border=0 SRC='images/remove.gif'></a></center></TD>
</TR>";
...
function Edit() {
$id = intval($_GET[id]);
$a = "select * from tqv_bdsquan where tqv_qhid = \"$id\"";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa hay không?')){
		location.href='tqvstatebds.php?dialoose=Delete&id=<? echo $c['tqv_qhid']; ?>';
	}
}
</SCRIPT>
<script src="images/date-picker.js"></script>
...
<SELECT NAME="tinhtrang" size=0>
	...
	<?php 
	$sqltd=@mysql_query("SELECT * FROM tqv_bdsquan WHERE tqv_qhid='$id'");
...
$id =intval($_GET[id]);
		...
		$q1 = "delete from tqv_bdsquan  where tqv_qhid= '$id' ";
		@mysql_query($q1) or die(mysql_error());
echo "
	<div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"1; url=tqvstatebds.php\"><br><br><br><br><br><br><br><br><br>
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
