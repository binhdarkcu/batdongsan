...
$member_id = addslashes($_SESSION['member_id']);
  ...
  if(isset($submit) && $submit == 'Add News') { 
    ...
    $timenowS = time();
    $ngaytk=date("d/m/20y"); 
    $qv =@mysql_query("INSERT INTO tqv_bdsnewsgt(tqvcatgt_id,tqvnewsgt_heading,tqvnewsgt_tomtat,tqvnewsgt_content,tqvnewsgt_source,tqvnewsgt_datec,tqvadmin_id,tqvnewsgt_status) VALUES('$theloai','$news_tieude','$news_subnoidung','$news_noidung','$nguontin','$ngaytk','$member_id','$tinhtrang')");
    if($qv==false){ echo"Loi".@mysql_error(); }
   echo '<br><br><br><br><br><br><div align="center">
<meta http-equiv="REFRESH" content="2; url=tqvnewgtbds.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="tqvnewgtbds.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> '; 
	exit;
  ...
  { 
    ...
    $timenowS = time();
    $ngaytk=date("d/m/20y");
      $qv =@mysql_query("INSERT INTO tqv_bdsnewsgt(tqvcatgt_id,tqvnewsgt_heading,tqvnewsgt_tomtat,tqvnewsgt_anhmh,tqvnewsgt_content,tqvnewsgt_source,tqvnewsgt_datec,tqvadmin_id,tqvnewsgt_status) VALUES('$theloai','$news_tieude','$news_subnoidung','$images3','$news_noidung','$nguontin','$ngaytk','$member_id','$tinhtrang')");
    if($qv==false){ echo"Loi".@mysql_error(); }
   echo '<br><br><br><br><br><br><div align="center">
<meta http-equiv="REFRESH" content="2; url=tqvnewgtbds.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  if(isset($submit) && $submit == 'Update')
  {
	...
	if ( $_FILES['userfile1']['name'] )
  	{
		...
		$id = intval( $_GET["id"] );
	  	$sql_select = @mysql_query("SELECT * FROM tqv_bdsnewsgt WHERE tqvnewsgt_id='$id'");
    ...
    $nguontin= $_POST["nguontin"];
    $ngaytk=date("d/m/20y");
	$q3 = "UPDATE tqv_bdsnewsgt SET
	tqvcatgt_id ='$theloai',
	tqvnewsgt_heading ='$news_tieude',
	tqvnewsgt_tomtat ='$news_subnoidung',
	";
	
	if ($images_small)
	{
		$q3 .= "
		tqvnewsgt_anhmh ='$images_small',
		";
	}
	
	$q3 .= "
	tqvnewsgt_content ='$news_noidung',tqvnewsgt_source='$nguontin',tqvnewsgt_datec='$ngaytk',tqvnewsgt_status='$duyettin' WHERE tqvnewsgt_id ='$id'
	";
	$r3 = @mysql_query($q3) or die(mysql_error());
	echo "
	<div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"3; url=tqvnewgtbds.php?dialoose=selectcat&cat=$theloai\"><br><br><br><br><br><br><br><br><br>
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"tqvnewgtbds.php?dialoose=selectcat&cat=$theloai\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>
</td></tr></table><br>";
  ...
  if($doitenkhong == 'co')
  {
 	$q3 = "update tqv_bdscategorynewsgt set tqvcatgt_name = \"$_POST[newname]\" where tqvcatgt_id = \"$_POST[id]\"";
 	$q2 = "update tqv_bdscategorynewsgt set tqvcatgt_name = \"$_POST[newid]\" where tqvcatgt_id= \"$_POST[id]\"";
  ...
  if($xoatheloai == 'co')
  {
 	$q5 = "DELETE FROM tqv_bdscategorynewsgt WHERE tqvcatgt_id= \"$_POST[id]\"";
...
{
	if (isset($newname)){
 	$q4 = "INSERT INTO tqv_bdscategorynewsgt (tqvcatgt_name) VALUES ('$newname')";
...
<script language='javascript' type='text/javascript'>
    ...
    {
    	temp = prompt( "", "'tqvnewgtbds.php?" + pid );
    	return false;
    }
...
<? $a="select * from tqv_bdscategorynewsgt";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><option value='<?=$row['tqvcatgt_id']?>'><?=$row['tqvcatgt_name']?></option>
<? }?> 
</select>
</td></tr>
<tr> 
...
function edit() {
$id = intval( $_GET["id"] );
$a = "select * from tqv_bdsnewsgt where tqvnewsgt_id='$id'";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa bài viết này không?')){
		location.href='tqvnewgtbds.php?dialoose=remove3&id=<? echo $c['tqvnewsgt_id']; ?>';
	}
}
</SCRIPT>
<script type="text/javascript" src=him.js></script>
...
<form method="post" NAME="mainform" enctype="multipart/form-data">
    <tr> 
      <td><font size="2"><b>Ti&#234;u &#273;&#7873;:</b></font><br>
<input onkeyup=initTyper(this); name="news_tieude" type="text" value="<? echo $c['tqvnewsgt_heading']; ?>"  size="105"></td>
    </tr>
  
<tr> 
            <td valign="top"><B>Th&#7875; lo&#7841;i :</B><br><SELECT NAME="theloai" size=0>
		<?
	$sel_cat=@mysql_query("select * from tqv_bdscategorynewsgt order by tqvcatgt_id");
	while($res=@mysql_fetch_array($sel_cat))
	{
?>
		<option value="<?php echo $res['tqvcatgt_id']; ?>" <?php if($c['tqvcatgt_id']==$res['tqvcatgt_id']){echo "selected";}?>><?echo $res['tqvcatgt_name'];?>
<?
	}
?>
				</select> </td>
...
<tr><td>
<?
if($c['tqvnewsgt_anhmh'])
{
echo("<br>(<a href=\"../images/newsbds/".$c['tqvnewsgt_anhmh']."\" target=\"_blank\">Click v&#224;o &#273;&#226;y &#273;&#7875; xem &#7842;nh hi&#7879;n t&#7841;i</a>)<br>");
}
?>
   <tr> 
    
      <td><font size="2"><b>Nguồn tin</b></font><br>
        <input  name="nguontin" type="text" id="nguontin" size="105" value="<? echo $c['tqvnewsgt_source']; ?>" ></td>
    </tr>
...
&nbsp;&nbsp;&nbsp;<select name="duyettin" id="duyettin" size=0>
	 <?php 
	$sqltt=@mysql_query("SELECT * FROM tqv_bdsnewsgt WHERE tqvnewsgt_id='$id'");
	while ($rowtt=@mysql_fetch_assoc($sqltt)){
		$vinh=$rowtt['tqvnewsgt_status'];
		         if($vinh==1){ ?>
                          <option value="<?php echo $rowtt['tqvnewsgt_status']; ?>">Tin &#273;&#432;&#7907;c duy&#7879;t</option>
                          <option value="0">Tin ch&#432;a &#273;&#432;&#7907;c duy&#7879;t</option>
                 <?php } else { ?>
                 		  <option value="<?php echo $rowtt['tqvnewsgt_status']; ?>">Tin ch&#432;a &#273;&#432;&#7907;c duy&#7879;t</option>
                          <option value="1">Tin &#273;&#432;&#7907;c duy&#7879;t</option>
                 	<?php }
    } 
    ?>	  
...
function select() {
	...
	$sql=@mysql_query("select * from tqv_bdsnewsgt where tqvnewsgt_status =0 order by tqvnewsgt_id desc"); //cau lenh truy van
   ...
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
    	    ...
    	    $listpage.="<a href='tqvnewgtbds.php?dialoose=select&&trang=$i' size='2'> $i</a>" ;//nguoc lai ta cho lien ket den bien $i
...
<div id="tipDiv" style="Z-INDEX:1; VISIBILITY:hidden; POSITION:absolute"></div>
 ...
 <table width="96%" border="0" cellspacing="0" cellpadding="2" >
  <tr>
   <td colspan=2 bgcolor="#4B9BE0"><img src="images/newsmodule.gif" width="21" height="20"  alt='Liệt kê tin tức | Select news' title='Liệt kê tin tức | Select news'/><b><font color="#FFFFFF" size=2> DANH SÁCH TIN TỨC </td></tr><tr><td colspan=1 bgcolor="#4B9BE0" width=70%><div align='right'><form action="tqvnewgtbds.php?dialoose=selectcat1" method='POST' name=hi><select name="theloai" id="theloai">
<?php 
$a="select * from tqv_bdscategorynewsgt";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><option value='<?=$row['tqvcatgt_id']?>'><font size=1><?=$row['tqvcatgt_name']?></option>
<? }?>     <input  name="submit" type="submit" id="submit" value="Tìm"></form></td></select>
<td colspan=1 bgcolor="#4B9BE0" width=30%><div align='right'><form action="tqvnewgtbds.php?dialoose=select" method='POST' name=vi><select name=ctnv size=0><option value=1> Tất cả tin tức</option><option value=2> Các tin đã duyệt</option><option value=3> Các tin chưa duyệt</option></select><input  name="submit" type="submit" id="submit" value="Liệt kê"></form></td></tr>
  </tr>
  <tr>
  ...
  <tr height=20>
      ...
      <tr onmouseover="this.bgColor='#CCCCCC'" onmouseout="this.bgColor='#FFFFFF'" bgColor=#ffffff>
        ...
        <td align="center" class=textxam12><A  href="tqvnewgtbds.php?dialoose=edit&id=<?php echo $row['tqvnewsgt_id'];?>" onmouseover="showtip('<?php if($vinh==1)echo ' <b>Bài viết đã được duyệt</b><br>Bạn click vào đây để xem chi tiết'; else echo 'Bạn click vào đây để xem chi tiết<br> Sửa và duyệt bài viết'; ?>')" 
            onmouseout="hidetip()"><?php if($vinh==1) echo "<b>&nbsp;".$row['tqvnewsgt_heading']."</b>"; else echo "&nbsp;".$row['tqvnewsgt_heading'];?></td>
        <td width="22%" align="center" class=textxam12><?php $theloai=$row['tqvcatgt_id']; $sqltl=@mysql_query("SELECT * FROM tqv_bdscategorynewsgt WHERE tqvcatgt_id='$theloai'"); $row5=@mysql_fetch_assoc($sqltl); echo "&nbsp;&nbsp;". $row5['tqvcatgt_name'];?></td>
        <td align="center" class=textxam12><a class='Market' ><?php echo $row['tqvnewsgt_datec'];?> </a></td>
         <td align="center" class=textxam12><a class='Market' href='#' onmouseover='doTooltip(event,"../images/newsbds/<?php echo $row['tqvnewsgt_anhmh'];?>","<div align=center> Ảnh minh họa chi tiết  cho bài viết")' onmouseout='hideTip()'><?php echo $row['tqvnewsgt_anhmh'];?> </a></td>
          <td width="7%" class=textxam12><div align="center"><a href="tqvnewgtbds.php?dialoose=edit&id=<?php echo $row['tqvnewsgt_id'];?>"><img src='images/icon_duyetbai.gif' width='16' height='16' border='0' alt='Chỉnh sửa tin tức | Change news' title='Chỉnh sửa tin tức | Change news'> </a></div></td>
        <td width="6%" class=textxam12><div align="center"><a href="javascript:baoloi('tqvnewgtbds.php?dialoose=remove3&id=<?php echo $row['tqvnewsgt_id'];?>')"><img src='images/drop.jpg' width='16' height='16' border='0' alt='Xoá tin tức  | Delete news' title='Xoá tin tức  | Delete news'> </a></div></td>
      </tr>
      <?php }
      $i++;
      if($i>=$page_end){
...
elseif($qv==2){
	...
	$page_start=($trang-1)*$rowperpage; //tinh $page_start dua vao $trang * $rowperpage vidu: $trang=1 ->$page_start=(1-1)*20=0
	$page_end=$trang*$rowperpage;//tinh $page_end dua vao $trang * $rowperpage vidu: $trang=2 ->$page_start=(2-1)*20=20
	$sql=@mysql_query("select * from tqv_bdsnewsgt where tqvnewsgt_status ='$tqv' order by tqvnewsgt_id desc"); //cau lenh truy van
	$totalrow=@mysql_num_rows($sql);// tinh tong so dong trong co so du lieu
    $number_page=ceil($totalrow/$rowperpage);// tinh tong so trang bang cach lay tong so dong chia cho so dong tren mot trang lay tron bang ham ceil.
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
...
<?php 
    ...
    $page_start=($trang-1)*$rowperpage; //tinh $page_start dua vao $trang * $rowperpage vidu: $trang=1 ->$page_start=(1-1)*20=0
	$page_end=$trang*$rowperpage;//tinh $page_end dua vao $trang * $rowperpage vidu: $trang=2 ->$page_start=(2-1)*20=20
	$sql=@mysql_query("select * from tqv_bdsnewsgt order by tqvnewsgt_id desc"); //cau lenh truy van
	$totalrow=@mysql_num_rows($sql);// tinh tong so dong trong co so du lieu
    $number_page=ceil($totalrow/$rowperpage);// tinh tong so trang bang cach lay tong so dong chia cho so dong tren mot trang lay tron bang ham ceil.
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
...
<TABLE class="Menubar" cellSpacing=2 cellPadding=1 width="100%" align=center bgColor=#4B9BE0 border=0>
		...
		&nbsp;&nbsp;<a href="tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request='+id+'"><b>'+xemten+'</b></a>\</td>');
...
$search_at="tqvnewsgt_heading";

$page = intval($_GET[page]);
$request=$_GET['request'];
if($page==""){ $page=1;}
if($request=="0-9"){
$sql=@mysql_query("SELECT * FROM tqv_bdsnewsgt WHERE tqvcatgt_id = '$cat' and  $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%'") or die(mysql_error());
} else {
$sql=@mysql_query("select * from tqv_bdsnewsgt where tqvcatgt_id = '$cat' and  $search_at like '$request%'") or die(mysql_error());
}
...
if($request=="0-9"){
$sql=@mysql_query("SELECT *  FROM tqv_bdsnewsgt WHERE tqvcatgt_id = '$cat' and $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%' order by tqvnewsgt_id desc limit $start,$limit") or die(mysql_error());
} else {
$sql=@mysql_query("select *  from tqv_bdsnewsgt where tqvcatgt_id = '$cat' and  $search_at like '$request%' order by tqvnewsgt_id desc limit $start,$limit") or die(mysql_error());
}
$j=0;
while($row=@mysql_fetch_array($sql)){
                                ...
                                $j++;
                                $id =$row["tqvnewsgt_id"]; 
                                $title = $row["tqvnewsgt_heading"];
                                $ngaydang= $row["tqvnewsgt_datec"]; 
                                $images = $row["tqvnewsgt_anhmh"];
                                $count = $row["tqvnews_counter"];
                                $post_date  = $row["tqvnewsgt_datec"]; 
                                $cat = $row["tqvcatgt_id"]; 
                                $tinhtrang=$row["tqvnewsgt_status"];
$sqlten=@mysql_query("select * from tqv_bdscategorynewsgt where tqvcatgt_id='$cat'"); $rowten=@mysql_fetch_array($sqlten);$quvinh=$rowten['tqvcatgt_name'];
echo"
<TR onmouseover=\"this.bgColor='#CCCCCC'\" onmouseout=\"this.bgColor='#FFFFFF'\" bgColor=#ffffff>
...
<TD align=middle alignt=middle><P class=textdo12>&nbsp;<a href=\"tqvnewgtbds.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textdo12>&nbsp;<a href=\"javascript:baoloi('tqvnewgtbds.php?dialoose=remove3&id=$id&file=$images')\">Xo&#225;</a></p</TD>
</TR>";
					}
echo("
</TBODY></TABLE>
...
if($page>1){
 echo "<TD class=NSDivCenter><A HREF=\"tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request=$request&page=1\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD>";
 $page=$page-1;
  echo "<TD class=NSDivCenter><b><A HREF=\"tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request=$request&page=$page\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD>";
  }
for($i;$i<=$max; $i++) {
...
if ($i==$page) {
        ...
        echo "<TD class=NSDivCenter>&nbsp;<A HREF=\"tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request=$request&page=$i\" class=song><font size=1><b>$i</b></font></A>&nbsp;</TD>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=NSDivCenter><b><A HREF=\"tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request=$request&page=$page\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD>"; 
	 echo "<TD class=NSDivCenter><A HREF=\"tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request=$request&page=$max_page\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
...
if($page==""){ $page=1;}
if($request=="0-9"){
$sql=@mysql_query("SELECT * FROM tqv_bdsnewsgt WHERE  tqvcatgt_id = '$theloai' and  $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%'") or die(mysql_error());
} else {
$sql=@mysql_query("select * from tqv_bdsnewsgt where tqvcatgt_id = '$theloai' and  $search_at like '$request%'") or die(mysql_error());
}
$total=@mysql_num_rows($sql);
$limit=10;
$max_page=ceil($total/$limit);
...
if($request=="0-9"){
$sql=@mysql_query("SELECT *  FROM tqv_bdsnewsgt WHERE tqvcatgt_id = '$theloai' and $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%' order by tqvnewsgt_id desc limit $start,$limit") or die(mysql_error());
} else {
$sql=@mysql_query("select *  from tqv_bdsnewsgt where tqvcatgt_id = '$theloai' and  $search_at like '$request%' order by tqvnewsgt_id desc limit $start,$limit") or die(mysql_error());
}
$j=0;
while($row=@mysql_fetch_array($sql)){
...
if($page>1){
 echo "<TD class=NSDivCenter><A HREF=\"tqvnewgtbds.php?dialoose=selectcat&request=$request&page=1\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD>";
 $page=$page-1;
  echo "<TD class=NSDivCenter><b><A HREF=\"tqvnewgtbds.php?dialoose=selectcat&cat=$cat&request=$request&page=$page\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD>";
  }
for($i;$i<=$max; $i++) {
...
$q1 = "delete from tqv_bdsnewsgt where tqvnewsgt_id = '$_GET[id]' ";
...
@unlink("../images/newsbds/".$_GET[file]);
	...
	redirect("tqvnewgtbds.php?dialoose=validate");
...
function remove3() {
	$id = intval( $_GET["id"] );
//delete the database record
$q1 = "delete from tqv_bdsnewsgt where tqvnewsgt_id='$id' ";
@mysql_query($q1) or die(mysql_error());
...
@unlink("../images/newsbds/".$_GET[file]);
	...
	redirect("tqvnewgtbds.php?dialoose=select");
...
$a = "SELECT * FROM tqv_bdsnewsgt where validate = '0' order by tqvnewsgt_id desc";
$b = @mysql_query($a) or die(mysql_error());
...
$a2 = "delete from tqv_bdsnewsgt where validate = '0'";
...
function category_delete() {
 	...
 	$q5 = "DELETE FROM tqv_bdscategorynewsgt WHERE tqvcatgt_id= \"$_GET[id]\"";
	$r5 = @mysql_query($q5) or die("loi DB khi doi ten the loai");
     redirect("tqvnewgtbds.php?dialoose=category");
...
function category() {
$a = "SELECT * FROM tqv_bdscategorynewsgt order by tqvcatgt_id";
...
<?
$a = "SELECT * FROM tqv_bdscategorynewsgt order by tqvcatgt_id ASC ";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa thể loại này?')){
		location.href='tqvnewgtbds.php?dialoose=category_delete&id=<? echo $c['tqvcatgt_id']; ?>';
	}
}
</SCRIPT>
  <tr>
...
<?=$c[tqvcatgt_id]?>
    ...
    <td bgcolor='#ffffff'><input onkeyup=initTyper(this); type='text' name='newname' value='<?=$c[tqvcatgt_name]?>' size='40'></a></td>
    <td bgcolor='#ffffff'><center>

<input type=hidden name='doitenkhong' value='co'>
<input type=hidden name='id' value='<?=$c[tqvcatgt_id]?>'>
...
echo "
  <tr>
    ...
    <td bgcolor='#FFFFff'><center>[ <a href='tqvnewgtbds.php?dialoose=edit2&id=$c[id]'>Xem</a> ] [ <a href=\"javascript:baoloi('tqvnewgtbds.php?dialoose=remove2&id=$c[id]&file=$c[images]')\">Xo&#225;</a> ]</center></td>
  </tr>";
  }
  ?>
</table>
<table bgcolor="#000000" width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor='#FFFFCC'><center>[ <a href='tqvnewgtbds.php?dialoose=deleteall'>Xo&#225; t&#7845;t c&#7843; Danh s&#225;ch m&#7899;i n&#224;y</a> ]</center></td>
  </tr>
</table>
