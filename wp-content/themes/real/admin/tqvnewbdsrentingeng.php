...
$member_id = addslashes($_SESSION['member_id']);
  ...
  if(isset($submit) && $submit == 'Add News') { 
    ...
    $tukhoa=$_POST['tukhoa'];
    $ngaytk=date("d/m/20y"); 
    $qv =@mysql_query("INSERT INTO tqv_bdsnewsbdseng(tqv_catebdsid,tqvnewsbds_tieude,tqvnewsbds_giathue,tqvnewsbds_gioithieu,tqvnewsbds_noidung,tqvnewsbds_ghichu,
...
<meta http-equiv="REFRESH" content="2; url=tqvnewbdsrentingeng.php">
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href="tqvnewbdsrentingeng.php">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br> '; 
	exit;
  ...
  { 
    ...
    @mysql_query("UPDATE tqv_bdsadmin SET tqvadmin_couterdb=tqvadmin_couterdb+1 WHERE tqvadmin_id='$member_id'");
      $qv =@mysql_query("INSERT INTO tqv_bdsnewsbdseng(tqv_catebdsid,tqvnewsbds_tieude,tqvnewsbds_giathue,tqvnewsbds_gioithieu,tqvnewsbds_noidung,tqvnewsbds_images,tqvnewsbds_ghichu,
    	tqv_qhid,tqvnewsbds_sophongngu,tqvnewsbds_dientichdat,tqvnewsbds_dtsd,tqvnewsbds_dacdiemchinh,tqvnewsbds_maso,tqvnewsbds_duong,tqvnewsbds_trangthai,
    	tqvnewsbds_tinhtrang,tqvnewsbds_ngay,tqvnewsbds_sieudulieumota,tqvnewsbds_sieudulieutukhoa,tqvadmin_id)
...
<table width="40%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  if(isset($submit) && $submit == 'Update')
  {
	...
	if ( $_FILES['userfile1']['name'] )
  	{
		...
		$id = intval( $_GET["id"] );
	  	$sql_select = @mysql_query("SELECT * FROM tqv_bdsnewsbdseng WHERE tqvnewsbds_id='$id'");
		...
		$images1 = $_FILES['userfile1']['name'];		
        $images_small = $rand_numb."$images1";
	...
	echo "
	<div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"3; url=tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$theloai\"><br><br><br><br><br><br><br><br><br>
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
      ...
      <img src=\"images/loading1.gif\" width=\"150\" height=\"13\" border=\"0\"> 
      <br>
      <br>(<a href=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$theloai\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>
</td></tr></table><br>";
  ...
  if($doitenkhong == 'co')
  {
 	$q3 = "update tqv_catebdseng set tqv_catename = \"$_POST[newname]\" where tqv_catebdsid = \"$_POST[id]\"";
 	$q2 = "update tqv_catebdseng set tqv_catename = \"$_POST[newid]\" where tqv_catebdsid= \"$_POST[id]\"";
  ...
  if($xoatheloai == 'co')
  {
 	$q5 = "DELETE FROM tqv_catebdseng WHERE tqv_catebdsid= \"$_POST[id]\"";
...
{
	if (isset($newname)){
 	$q4 = "INSERT INTO tqv_catebdseng (tqv_catename) VALUES ('$newname')";
...
<script language='javascript' type='text/javascript'>
    ...
    {
    	temp = prompt( "", "'tqvnewbdsrentingeng.php?" + pid );
    	return false;
    }
...
<tr> 
      <td><font size="2"><b>Giá Thuê:</b></font><br>
       <input name="giathue" type="text"  id="giathue" size="105"/></td>
    </tr>
   <tr> 
...
<? $a="select * from tqv_bdsquaneng";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><option value='<?=$row['tqv_qhengid']?>'><?=$row['tqv_qhengname']?></option>
<? }?> 
</select>
</td></tr>    		
<tr> 
...
function edit() {
$id = intval( $_GET["id"] );
$a = "select * from tqv_bdsnewsbdseng where tqvnewsbds_id='$id'";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa bài viết này không?')){
		location.href='tqvnewbdsrentingeng.php?dialoose=remove3&id=<? echo $c['tqvnewsbds_id']; ?>';
	}
}
</SCRIPT>
<script type="text/javascript" src=him.js></script>
...
<tr> 
    ...
    <tr> 
     ...
     <textarea  name="ghichu" style="width:70%;height:100px;" id="ghichu"><?=$c['tqvnewsbds_ghichu']; ?>
  		...
  		<tr> 
      <td><font size="2"><b>Giá Thuê:</b></font><br>
      	<input name="giathue" type="text"  id="giathue" size="105" value="<? echo $c['tqvnewsbds_giathue']; ?>"/>	
        	</td>
    </tr>
   <tr> 
      <td><font size="2"><b>Số phòng ngủ:</b></font><br>
...
while ($row = @mysql_fetch_array($result))
{?>
    <option value="<?php echo $row['tqv_qhengid']; ?>" <?php if($c['tqv_qhengid']==$row['tqv_qhengid']){echo "selected";}?>><?echo $row['tqv_qhengname'];?>	
...
&nbsp;&nbsp;&nbsp;<select name="duyettin" id="duyettin" size=0>
	 <?php 
	$sqltt=@mysql_query("SELECT * FROM tqv_bdsnewsbdseng WHERE tqvnewsbds_id='$id'");
...
function select() {
	...
	$sql=@mysql_query("select * from tqv_bdsnewsbdseng where tqvnewsbds_tinhtrang =0 order by tqvnewsbds_id desc"); //cau lenh truy van
   ...
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
    	    ...
    	    $listpage.="<a href='tqvnewbdsrentingeng.php?dialoose=select&&trang=$i' size='2'> $i</a>" ;//nguoc lai ta cho lien ket den bien $i
...
<div id="tipDiv" style="Z-INDEX:1; VISIBILITY:hidden; POSITION:absolute"></div>
 ...
 <table width="96%" border="0" cellspacing="0" cellpadding="2" >
  <tr>
   <td colspan=2 bgcolor="#4B9BE0"><img src="images/newsmodule.gif" width="21" height="20"  alt='Liệt kê tin tức | Select news' title='Liệt kê tin tức | Select news'/><b><font color="#FFFFFF" size=2> DANH SÁCH TIN TỨC </td></tr><tr><td colspan=1 bgcolor="#4B9BE0" width=70%><div align='right'><form action="tqvnewbdsrentingeng.php?dialoose=selectcat1" method='POST' name=hi><select name="theloai" id="theloai">
<?php 
$a="select * from tqv_catebdseng";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
...
<td colspan=1 bgcolor="#4B9BE0" width=30%><div align='right'><form action="tqvnewbdsrentingeng.php?dialoose=select" method='POST' name=vi><select name=ctnv size=0><option value=1> Tất cả tin tức</option><option value=2> Các tin đã duyệt</option><option value=3> Các tin chưa duyệt</option></select><input  name="submit" type="submit" id="submit" value="Liệt kê"></form></td></tr>
  ...
  <tr height=20>
      ...
      <tr onmouseover="this.bgColor='#CCCCCC'" onmouseout="this.bgColor='#FFFFFF'" bgColor=#ffffff>
        ...
        <td align="center" class=textxam12><A  href="tqvnewbdsrentingeng.php?dialoose=edit&id=<?php echo $row['tqvnewsbds_id'];?>" onmouseover="showtip('<?php if($vinh==1)echo ' <b>Bài viết đã được duyệt</b><br>Bạn click vào đây để xem chi tiết'; else echo 'Bạn click vào đây để xem chi tiết<br> Sửa và duyệt bài viết'; ?>')" 
            onmouseout="hidetip()"><?php if($vinh==1) echo "<b>&nbsp;".$row['tqvnewsbds_tieude']."</b>"; else echo "&nbsp;".$row['tqvnewsbds_tieude'];?></td>
        <td width="22%" align="center" class=textxam12><?php $theloai=$row['tqv_catebdsid']; $sqltl=@mysql_query("SELECT * FROM tqv_catebdseng WHERE tqv_catebdsid='$theloai'"); $row5=@mysql_fetch_assoc($sqltl); echo "&nbsp;&nbsp;". $row5['tqv_catename'];?></td>
        <td align="center" class=textxam12><a class='Market' ><?php echo $row['tqvnewsbds_ngay'];?> </a></td>
         <td align="center" class=textxam12><a class='Market' ><div align="center"><a href="tqvuploadimgrentingengbds.php?imgid=<?php echo $row['tqvnewsbds_id'];?>"><?php $ga=$row['tqvnewsbds_id']; $sqlanhbv=@mysql_query("select * from tqv_bdsnewsimagesengbds where tqvnewsbds_id='$ga'"); $tonganh=@mysql_num_rows($sqlanhbv);if($tonganh){ echo "<b>Đã có ảnh </b>"; } else {echo "Chưa có ảnh";} ?> </a></td> 	  
         <td align="center" class=textxam12><a class='Market' href='#' onmouseover='doTooltip(event,"../images/newsbds/<?php echo $row['tqvnewsbds_images'];?>","<div align=center> Ảnh minh họa chi tiết  cho bài viết")' onmouseout='hideTip()'><?php echo $row['tqvnewsbds_images'];?> </a></td>
          <td width="5%" class=textxam12><div align="center"><a href="tqvuploadimgrentingengbds.php?imgid=<?php echo $row['tqvnewsbds_id'];?>"><img src='images/uploadimagesw.png' width='16' height='16' border='0' alt='upload ảnh' title='Upload Ảnh'> </a></div></td>
          <td width="5%" class=textxam12><div align="center"><a href="tqvnewbdsrentingeng.php?dialoose=edit&id=<?php echo $row['tqvnewsbds_id'];?>"><img src='images/icon_duyetbai.gif' width='16' height='16' border='0' alt='Chỉnh sửa tin tức | Change news' title='Chỉnh sửa tin tức | Change news'> </a></div></td>
        <td width="5%" class=textxam12><div align="center"><a href="javascript:baoloi('tqvnewbdsrentingeng.php?dialoose=remove3&id=<?php echo $row['tqvnewsbds_id'];?>')"><img src='images/drop.jpg' width='16' height='16' border='0' alt='Xoá tin tức  | Delete news' title='Xoá tin tức  | Delete news'> </a></div></td>
      </tr>
      <?php }
      $i++;
      if($i>=$page_end){
...
elseif($qv==2){
	...
	$page_start=($trang-1)*$rowperpage; //tinh $page_start dua vao $trang * $rowperpage vidu: $trang=1 ->$page_start=(1-1)*20=0
	$page_end=$trang*$rowperpage;//tinh $page_end dua vao $trang * $rowperpage vidu: $trang=2 ->$page_start=(2-1)*20=20
	$sql=@mysql_query("select * from tqv_bdsnewsbdseng where tqvnewsbds_tinhtrang ='$tqv' order by tqvnewsbds_id desc"); //cau lenh truy van
	$totalrow=@mysql_num_rows($sql);// tinh tong so dong trong co so du lieu
    $number_page=ceil($totalrow/$rowperpage);// tinh tong so trang bang cach lay tong so dong chia cho so dong tren mot trang lay tron bang ham ceil.
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
...
<?php 
    ...
    $page_start=($trang-1)*$rowperpage; //tinh $page_start dua vao $trang * $rowperpage vidu: $trang=1 ->$page_start=(1-1)*20=0
	$page_end=$trang*$rowperpage;//tinh $page_end dua vao $trang * $rowperpage vidu: $trang=2 ->$page_start=(2-1)*20=20
	$sql=@mysql_query("select * from tqv_bdsnewsbdseng order by tqvnewsbds_id desc"); //cau lenh truy van
	$totalrow=@mysql_num_rows($sql);// tinh tong so dong trong co so du lieu
    $number_page=ceil($totalrow/$rowperpage);// tinh tong so trang bang cach lay tong so dong chia cho so dong tren mot trang lay tron bang ham ceil.
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
...
<TABLE class="Menubar" cellSpacing=2 cellPadding=1 width="100%" align=center bgColor=#4B9BE0 border=0>
		...
		&nbsp;&nbsp;<a href="tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request='+id+'"><b>'+xemten+'</b></a>\</td>');
...
if($page==""){ $page=1;}
if($request=="0-9"){
$sql=@mysql_query("SELECT * FROM tqv_bdsnewsbdseng WHERE tqv_catebdsid = '$cat' and  $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%'") or die(mysql_error());
} else {
$sql=@mysql_query("select * from tqv_bdsnewsbdseng where tqv_catebdsid = '$cat' and  $search_at like '$request%'") or die(mysql_error());
}
...
if($request=="0-9"){
$sql=@mysql_query("SELECT *  FROM tqv_bdsnewsbdseng WHERE tqv_catebdsid = '$cat' and $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%' order by tqvnewsbds_id desc limit $start,$limit") or die(mysql_error());
} else {
$sql=@mysql_query("select *  from tqv_bdsnewsbdseng where tqv_catebdsid = '$cat' and  $search_at like '$request%' order by tqvnewsbds_id desc limit $start,$limit") or die(mysql_error());
}
$j=0;
...
$sqlten=@mysql_query("select * from tqv_catebdseng where tqv_catebdsid='$cat'"); $rowten=@mysql_fetch_array($sqlten);$quvinh=$rowten['tqv_catename'];
echo"
<TR onmouseover=\"this.bgColor='#CCCCCC'\" onmouseout=\"this.bgColor='#FFFFFF'\" bgColor=#ffffff>
...
<TD align=middle alignt=middle><P class=textdo12>&nbsp;<a href=\"tqvnewbdsrentingeng.php?dialoose=edit&id=$id\">S&#7917;a</a></P></TD>
<TD align=middle alignt=middle><P class=textdo12>&nbsp;<a href=\"javascript:baoloi('tqvnewbdsrentingeng.php?dialoose=remove3&id=$id&file=$images')\">Xo&#225;</a></p</TD>
</TR>";
					}
echo("
</TBODY></TABLE>
...
if($page>1){
 echo "<TD class=NSDivCenter><A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request=$request&page=1\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD>";
 $page=$page-1;
  echo "<TD class=NSDivCenter><b><A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request=$request&page=$page\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD>";
  }
for($i;$i<=$max; $i++) {
...
if ($i==$page) {
        ...
        echo "<TD class=NSDivCenter>&nbsp;<A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request=$request&page=$i\" class=song><font size=1><b>$i</b></font></A>&nbsp;</TD>";
		}
	}
	if($page<=$max_page-1){
	$page=$page+1;
	 echo "<TD class=NSDivCenter><b><A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request=$request&page=$page\" title=\"Trang ti&#7871;p\" class=song><img height=15 src=\"images/bullet1.png\" width=15 border=0></A></b></TD>"; 
	 echo "<TD class=NSDivCenter><A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request=$request&page=$max_page\" title=\"Trang cu&#7889;i $max_page\" class=song><img height=15 src=\"images/bullet3.png\" width=15 border=0></A></TD>";
...
if($page==""){ $page=1;}
if($request=="0-9"){
$sql=@mysql_query("SELECT * FROM tqv_bdsnewsbdseng WHERE  tqv_catebdsid = '$theloai' and  $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%'") or die(mysql_error());
} else {
$sql=@mysql_query("select * from tqv_bdsnewsbdseng where tqv_catebdsid = '$theloai' and  $search_at like '$request%'") or die(mysql_error());
}
$total=@mysql_num_rows($sql);
$limit=10;
$max_page=ceil($total/$limit);
...
if($request=="0-9"){
$sql=@mysql_query("SELECT *  FROM tqv_bdsnewsbdseng WHERE tqv_catebdsid = '$theloai' and $search_at like '0%' OR $search_at like '1%' OR $search_at like '2%' OR $search_at like '3%' OR $search_at like '4%' OR $search_at like '5%' OR $search_at like '6%' OR $search_at like '7%' OR $search_at like '8%' OR $search_at like '9%' order by tqvnewsbds_id desc limit $start,$limit") or die(mysql_error());
} else {
$sql=@mysql_query("select *  from tqv_bdsnewsbdseng where tqv_catebdsid = '$theloai' and  $search_at like '$request%' order by tqvnewsbds_id desc limit $start,$limit") or die(mysql_error());
}
$j=0;
while($row=@mysql_fetch_array($sql)){
...
if($page>1){
 echo "<TD class=NSDivCenter><A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&request=$request&page=1\" title=\"Trang &#273;&#7847;u\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></TD>";
 $page=$page-1;
  echo "<TD class=NSDivCenter><b><A HREF=\"tqvnewbdsrentingeng.php?dialoose=selectcat&cat=$cat&request=$request&page=$page\" title=\"Trang tr&#432;&#7899;c\" class=song><img height=15 src=\"images/page_first.gif\" width=15 border=0></A></b></TD>";
  }
for($i;$i<=$max; $i++) {
...
$q1 = "delete from tqv_bdsnewsbdseng where tqvnewsbds_id = '$_GET[id]' ";
...
@unlink("../images/newsbds/".$_GET[file]);
	...
	redirect("tqvnewbdsrentingeng.php?dialoose=validate");
...
function remove3() {
	$id = intval( $_GET["id"] );
//delete the database record
$q1 = "delete from tqv_bdsnewsbdseng where tqvnewsbds_id='$id' ";
@mysql_query($q1) or die(mysql_error());
...
@unlink("../images/newsbds/".$_GET[file]);
	...
	redirect("tqvnewbdsrentingeng.php?dialoose=select");
...
$a = "SELECT * FROM tqv_bdsnewsbdseng where validate = '0' order by tqvnewsbds_id desc";
$b = @mysql_query($a) or die(mysql_error());
...
$a2 = "delete from tqv_bdsnewsbdseng where validate = '0'";
...
function category_delete() {
 	...
 	$q5 = "DELETE FROM tqv_catebdseng WHERE tqv_catebdsid= \"$_GET[id]\"";
	$r5 = @mysql_query($q5) or die("loi DB khi doi ten the loai");
     redirect("tqvnewbdsrentingeng.php?dialoose=category");
...
function category() {
$a = "SELECT * FROM tqv_catebdseng order by tqv_catebdsid";
...
<?
$a = "SELECT * FROM tqv_catebdseng order by tqv_catebdsid ASC ";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa thể loại này?')){
		location.href='tqvnewbdsrentingeng.php?dialoose=category_delete&id=<? echo $c['tqv_catebdsid']; ?>';
	}
}
</SCRIPT>
  <tr>
...
echo "
  <tr>
    ...
    <td bgcolor='#FFFFff'><center>[ <a href='tqvnewbdsrentingeng.php?dialoose=edit2&id=$c[id]'>Xem</a> ] [ <a href=\"javascript:baoloi('tqvnewbdsrentingeng.php?dialoose=remove2&id=$c[id]&file=$c[images]')\">Xo&#225;</a> ]</center></td>
  </tr>";
  }
  ?>
</table>
<table bgcolor="#000000" width="100%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor='#FFFFCC'><center>[ <a href='tqvnewbdsrentingeng.php?dialoose=deleteall'>Xo&#225; t&#7845;t c&#7843; Danh s&#225;ch m&#7899;i n&#224;y</a> ]</center></td>
  </tr>
</table>
