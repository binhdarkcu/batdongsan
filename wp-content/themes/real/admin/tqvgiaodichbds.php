...
function index() {
	...
	$sql=@mysql_query("select * from tqv_bdscontactrenting order by contact_id desc"); //cau lenh truy van
   ...
   if($number_page>=1){   //neu so trang lon hon 1 thi
     	$listpage="<div align='right'><img src='images/annoicon.gif' height='20' width='20' border='0' alt='Số trang | Total page'> <font color='blue' size='2'> Trang:"; //$listpage la chuoi de in ra tu Trang
    	    ...
    	    $listpage.="<a href='tqvgiaodichbds.php?dialoose=select&&trang=$i' size='2'> $i</a>" ;//nguoc lai ta cho lien ket den bien $i
...
<script language='javascript' type='text/javascript'>
    ...
    {
    	temp = prompt( "", "'tqvgiaodichbds.php?" + pid );
    	return false;
    }
...
<div id="tipDiv" style="Z-INDEX:1; VISIBILITY:hidden; POSITION:absolute"></div>
 ...
 <table width="96%" border="0" cellspacing="0" cellpadding="2" >
  <tr>
   <td colspan=2 bgcolor="#4B9BE0"><img src="images/newsmodule.gif" width="21" height="20"  alt='Liệt kê tin tức | Select news'/><b><font color="#FFFFFF" size=2> DANH SÁCH BẠN ĐỌC LIÊN HỆ GIAO DỊCH </td></tr>
  <tr>
  ...
  <tr>
   ...
   <tr height=20>
      ...
      <tr onmouseover="this.bgColor='#CCCCCC'" onmouseout="this.bgColor='#FFFFFF'" bgColor=#ffffff>
        ...
        <td width="7%" class=textxam12><div align="center"><a href="tqvgiaodichbds.php?dialoose=Edit&id=<?php echo $row['contact_id'];?>"><img src='images/icon_duyetbai.gif' width='16' height='16' border='0' alt='Xem tin liên hệ | Change contact'> </a></div></td>
        <td width="6%" class=textxam12><div align="center"><a href="javascript:baoloi('tqvgiaodichbds.php?dialoose=Delete&id=<?php echo $row['contact_id'];?>')"><img src='images/drop.jpg' width='16' height='16' border='0' alt='Xoá tin liên hệ  | Delete contact'> </a></div></td>
      </tr>
      <?php }
      $i++;
      if($i>=$page_end){
...
function Edit() {
$id = intval($_GET[id]);
$a = "select * from tqv_bdscontactrenting where contact_id='$id'";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn là muốn xóa không vậy?')){
		location.href='tqvgiaodichbds.php?dialoose=Delete&id=<? echo $c['contact_id']; ?>';
	}
}
</SCRIPT>
...
<table width="96%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td height="19" valign="middle" background="img/topbarfolder.gif"> <center>
        <strong><font color="red">Xem thông tin liên hệ giao dịch</font><br>
      </center></td>
        </tr>
        <tr>
...
<td><textarea  name="noidung" style="width:70%;height:250px;" id="noidung"><?=$c['contact_content']; ?>
    ...
    <?php if($c['tqv_language']=="Việt Nam"){ ?>
        <tr> 
            <td valign="top"><B>Ngôn ngữ bất động sản :</B></td>
<td><?php 
echo $c['tqv_language'];
?>
   ...
   <tr> 
            <td valign="top"><B>Tiêu đề bất động sản :</B></td>
<td><?php 
$news=$c['tqvnewsbds_id'];
$a="select * from tqv_bdsnewsbds where tqvnewsbds_id='$news'";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><A  href="tqvnewbdsrenting.php?dialoose=edit&id=<?php echo $row['tqvnewsbds_id'];?>">
	<?php echo $row['tqvnewsbds_tieude']?></a>
<? }?>
      ...
      <tr> 
            <td valign="top"><B>Thể loại bất động sản :</B></td>
<td><?php 
$cate=$c['tqv_catebdsid'];
$a="select * from tqv_catebds where tqv_catebdsid='$cate'";
$result = @mysql_query($a) or die ("loi");
$row = @mysql_fetch_array($result);
echo $row['tqv_catename']
	?>
...
<td><?php 
$news=$c['tqvnewsbds_id'];
$a="select * from tqv_bdsnewsbdseng where tqvnewsbds_id='$news'";
$result = @mysql_query($a) or die ("loi");
while ($row = @mysql_fetch_array($result))
{?><A  href="tqvnewbdsrentingeng.php?dialoose=edit&id=<?php echo $row['tqvnewsbds_id'];?>">
	<?php echo $row['tqvnewsbds_tieude']?></a>
<? }?>
...
<td><?php 
$cate=$c['tqv_catebdsid'];
$a="select * from tqv_catebdseng where tqv_catebdsid='$cate'";
$result = @mysql_query($a) or die ("loi");
$row = @mysql_fetch_array($result);
echo $row['tqv_catename']
	?>
...
$id =intval($_GET[id]);
		...
		$q1 = "delete from tqv_bdscontactrenting where contact_id='$id'";
		@mysql_query($q1) or die(mysql_error());
echo "
	<div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"1; url=tqvgiaodichbds.php\"><br><br><br><br><br><br><br><br><br>
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href=\"tqvgiaodichbds.php\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>
</td></tr></table><br>";
