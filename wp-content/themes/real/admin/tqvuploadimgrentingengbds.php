...
elseif(!getimagesize($_FILES['file_upload']['tmp_name'])) { 
   ...
   $q3 = "insert into tqv_bdsnewsimagesengbds set tqvnewsbds_id='$imgid',
	...
	echo "
	<div align=\"center\">
            <meta http-equiv=\"REFRESH\" content=\"3; url=tqvuploadimgrentingengbds.php?imgid=$imgid\"><br><br><br><br><br><br><br><br><br>
  ...
  <tr>
	...
	<legend>Please stand by ...
      ...
      <br>
      <br>(<a href=\"tqvuploadimgrentingengbds.php?imgid=$imgid\">Click v&#224;o &#273;&#226;y n&#7871;u k&#244; mu&#7889;n &#273;&#7907;i l&#226;u</a>)</p>
</fieldset></td>
  </tr>
</table></div><br><br>
</td></tr></table><br>";
...
if ( $_FILES['file_upload']['name'] )
  	{
	  	...
	  	$sql_select = @mysql_query("SELECT * FROM tqv_bdsnewsimagesengbds  WHERE tqvbdsimages_id='{$id}'");
...
if($_FILES['file_upload']['name'] == '') { 
    ...
    $member_id = addslashes($_SESSION['member_id']); 
	 $imgid=intval($_GET['imgid']);	
   	$q3 = "update tqv_bdsnewsimagesengbds set tqvnewsbds_id='$imgid',
...
<form method="post" name="dk" onsubmit="return check_form(this)" action='tqvuploadimgrentingengbds.php?dialoose=addimg&imgid=<?php echo $imgid ?>' enctype="multipart/form-data">
<center>
<table width="90%" border="0" cellpadding="0" cellspacing="0" borderColor=#111111>
    ...
    <td height="19" valign="middle" background="img/topbarfolder.gif"> <center>
        <strong><font color="red">Hình ảnh cho bài viết <a href="tqvnewbdsrentingeng.php?dialoose=edit&id=<?php echo $rowle['tqvnewsbds_id'];?>"><?php echo $tqvnewsbds_tieude; ?></a></font><br>
      </center></td>
        </tr>
        <tr>
...
<script language='javascript' type='text/javascript'>
    ...
    {
    	temp = prompt( "", "'tqvuploadimgrentingengbds.php?" + pid );
    	return false;
    }
...
<TD align=\"left\">&nbsp;&nbsp;<a class='Market' href='tqvuploadimgrentingengbds.php?dialoose=Edit&id=$id&imgid=$imgid' onmouseover='doTooltip(event,\"../images/newsbds/$files\",\"$chuthich\")' onmouseout='hideTip()'> $files
 </TD>
 <td>$tinhtrang</td>
...
<TD><center>
<a class='Market' href='tqvuploadimgrentingengbds.php?dialoose=Edit&id=$id&imgid=$imgid'>S&#7917;a</a>
</center></TD>
<TD><center><a href=\"javascript:baoloi('tqvuploadimgrentingengbds.php?dialoose=Delete&id=$id&file=$images&imgid=$imgid')\">Xo&#225;</a></center></TD>
</TR>";
...
$id = intval($_GET[id]);
$a = "select * from tqv_bdsnewsimagesengbds where tqvbdsimages_id= \"$id\"";
...
function Deletepost(){
	if(confirm('Bạn có chắc chắn muốn xóa không ?')){
		location.href='tqvuploadimgrentingengbds.php?dialoose=Delete&id=<? echo $c['tqvbdsimages_id']; ?>';
	}
}
</SCRIPT>
<script src="images/date-picker.js"></script>
<form method="POST" name="dk1"  action="tqvuploadimgrentingengbds.php?dialoose=readdimg&id=<?php echo $id; ?>&imgid=<?php echo $imgid ?>" enctype="multipart/form-data">
<center>
<table width="95%" border="0" cellpadding="0" cellspacing="0">
        <tr>
    <td height="19" valign="middle" background="img/topbarfolder.gif"> <center>
        <strong><font color="red">S&#7917;a Hình Ảnh cho bài viết <a href="tqvnewbdsrentingeng.php?dialoose=edit&id=<?php echo $rowle['tqvnewsbds_id'];?>"><?php echo $tqvnewsbds_tieude; ?></a></font><br>
      </center></td>
        </tr>
        <tr>
...
echo "
	<div align=\"center\">
<meta http-equiv=\"REFRESH\" content=\"1; url=tqvuploadimgrentingengbds.php?imgid=$imgid\"><br><br><br><br><br><br><br><br><br>
<table width=\"40%\"  border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  <tr>
    <td align=\"center\" valign=\"top\"><fieldset style=\"padding: 2; width:312px; height:59px\">
	<legend>Please stand by ...
